<template>
  <div>
    <p>Before you start please check that your controller is using circuit python, if not please download the matching firmware and drag it on the usb drive that appears when you enter its bootloader mode</p>
    <p>when you see the circuit python usb drive it is a good time to rename the drive to reflect your keyboard name</p>
    <p>With this done please select the drive so POG can start to flash the firmware, you will be able to configure everything after the flashing is done</p>
  ...
  <div v-if="false">
    ...
    <p>listen for serial ports with pog manufacturer then grab its info and compare with created id</p>
